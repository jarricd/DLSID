...
if __name__ == "__main__":
    img_white = np.zeros([600, 600, 3], dtype=np.float) + 1
    ...
    noisy_black = unprocessing.add_noise(img_white, shot_noise, read_noise, amplification=5).eval(session=tensorflow.compat.v1.Session())
